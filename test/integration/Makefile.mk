...
test_integration_IntegrationTests_LDADD = $(top_builddir)/test/integration/utils/libTinySamIntegrationTestUtils.a

if WINDOWS
noinst_PROGRAMS += test/integration/CreateParentProcess test/integration/CreateChildProcess
